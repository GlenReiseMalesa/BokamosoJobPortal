<%@ Page Title="" Language="C#" MasterPageFile="~/Index.Master" AutoEventWireup="true" CodeBehind="About.aspx.cs" Inherits="Bokamoso_Job_Portal.About" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">


    <!-- main content-->
<!-- bg header -->
<section class="jumbotron text-center" style="margin-top: 5%;height: 60%;">
    <div class="container">
