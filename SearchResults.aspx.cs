...
namespace Bokamoso_Job_Portal
{
    public partial class SearchResults : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                string keywords = Request.QueryString["query"].ToLower();

                if (row.JobTitle.ToLower().Contains(keywords) | row.JobDescription.ToLower().Contains(keywords)) {
                //The description or title contain a certain keyword
                    numJobs += 1;
